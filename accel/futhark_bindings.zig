...
pub extern "c" fn futhark_context_config_set_platform(cfg: ?*struct_futhark_context_config, platform: ?[*:0]const u8) void;
...
pub extern "c" fn futhark_context_get_error(ctx: ?*struct_futhark_context) ?[*:0]u8;
...
pub extern "c" fn futhark_entry_rsf_forward(
    ...
    s_bias: ?*const struct_futhark_f16_1d,
    t_bias: ?*const struct_futhark_f16_1d,
    clip_min: u16,
    clip_max: u16,
) c_int;
...
pub extern "c" fn futhark_entry_scale_weights_inplace(ctx: ?*struct_futhark_context, out: ?*?*struct_futhark_f16_2d, weights: ?*const struct_futhark_f16_2d, scale: u16) c_int;
...
pub extern "c" fn futhark_entry_training_step(
    ...
    loss: ?*u16,
    inputs: ?*const struct_futhark_f16_2d,
    targets: ?*const struct_futhark_f16_2d,
    weights_s: ?*const struct_futhark_f16_2d,
    weights_t: ?*const struct_futhark_f16_2d,
    s_bias: ?*const struct_futhark_f16_1d,
    t_bias: ?*const struct_futhark_f16_1d,
    velocity_s: ?*const struct_futhark_f16_2d,
    velocity_t: ?*const struct_futhark_f16_2d,
    velocity_sb: ?*const struct_futhark_f16_1d,
    velocity_tb: ?*const struct_futhark_f16_1d,
    learning_rate: u16,
    momentum: u16,
    clip_min: u16,
    clip_max: u16,
